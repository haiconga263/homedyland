 ...
 **/
class bizi_about extends WP_Widget{
	...
	public function __construct() {
		...
		$widget_ops = array('classname' => 'about', 'description' => esc_html__('Easy add About.', 'bizi'));

		/* Create the widget. */
		parent::__construct('about', esc_html__('+NA: About', 'bizi'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
...
function bizi_about(){
	register_widget('bizi_about');
}
add_action('widgets_init','bizi_about');
?>