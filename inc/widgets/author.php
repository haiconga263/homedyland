 ...
 **/
class bizi_author extends WP_Widget{

	/*function construct*/
	public function __construct() {
		/* Widget control settings. */
		$control_ops = array('width' => 250, 'height' => 350, 'id_base' => 'author');
		$widget_ops = array('classname' => 'about', 'description' => esc_html__('Easy add author.', 'bizi'));

		/* Create the widget. */
		parent::__construct('author', esc_html__('+NA: author', 'bizi'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
	public function widget($args, $instance) {
		extract($args);
			...
			<h2 class="widgettitle"><?php echo  get_the_author_posts_link();?></h2>
...
function bizi_author(){
	register_widget('bizi_author');
}
add_action('widgets_init','bizi_author');
?>