<?php
  ...
  * widgets support
  **/
  class bizi_support extends WP_Widget{

      /*function construct*/
      public function __construct() {
          parent::__construct(
            'support',__('+NA: Support','bizi'),
             array('description'=>__('Display Support info', 'bizi'))
          );
      }
      /**
       * font-end widgets
      ...
      */
      public function form($instance){
          ...
          ?>
          <p>
              <label for=<?php echo esc_attr($this->get_field_id('icon')); ?>><?php esc_html_e('Icon:','bizi') ; ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('text-support')); ?>"><?php esc_html_e( 'Text support:', 'bizi' ); ?></label>
          ...
          <!-- description -->
          <p>
              <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e('Description:', 'bizi'); ?></label>
  ...
  function bizi_support(){
      register_widget('bizi_support');
  }
  add_action('widgets_init','bizi_support');
?>