<?php
if (!class_exists('bizi_social')) {
    class bizi_social extends WP_Widget
    {
        ...
        function bizi_social()
        {
            $widget_ops = array('classname' => 'bizi_social', 'description' => esc_html__('Displays your social profile.', 'bizi'));

            parent::__construct(false, esc_html__('+NA: Social', 'bizi'), $widget_ops);
        }
        ...
        function widget($args, $instance)
        {
            ...
            echo '<div class="bizi-social-icon clearfix">';
...
add_action('widgets_init', 'bizi_social_widgets');

function bizi_social_widgets()
{
    register_widget('bizi_social');
}
