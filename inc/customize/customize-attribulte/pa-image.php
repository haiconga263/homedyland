...
?>
<ul class="bizi-custom-simple image clearfix" data-attribute="<?php echo esc_attr( $attribute['name'] ); ?>">
	<?php 
	...
	foreach ( $values as $value ) :
		...
		if ( $term ) :
			$link = get_woocommerce_term_meta( $term->term_id, "{$attribute['name']}_bizi_value" );
			?>
