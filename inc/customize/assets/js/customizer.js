(function ($) {
    ...
    $(document).ready(function() {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.bizi-slider-range-input' ),
                sliderRange = $(this).find( '.bizi-slider-range' );

            $(this).find('.bizi-slider-range').slider({
                range: "min",
        ...
        $( '.bizi-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.bizi-slider-range-input' ).on( 'change', function() {
